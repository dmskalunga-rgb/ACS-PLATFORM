...
| VOL-VIII 8.2–8.4                        | Complete test/evidence/DoD chain         | DoR                  | migration → service → API → UI → event              | local check, PostgreSQL and remote CI       | This matrix                 | `PENDING_REMOTE_CI` |
