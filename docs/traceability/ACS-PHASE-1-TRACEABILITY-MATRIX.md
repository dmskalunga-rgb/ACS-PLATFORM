...
| ------------------------------ | ----------------------------------------------- | -------------------------------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------ | ----------------------------------- | ------------------------------- |
| VOL-II-2.3/2.7; VOL-VI-6.1–6.5 | Canonical tenant authorization lifecycle        | ADR-0007, ADR-0011, ADR-0012, ADR-0014 | roles, role_permissions, membership_roles, versioned memberships       | PostgreSQL migration, roles, FORCE RLS and direct cross-tenant SQL | `TENANT-ADMINISTRATION-EVIDENCE.md` | `LOCAL_VERIFIED_REMOTE_PENDING` |
| VOL-VII-7.3/7.4                | Governed `/api/v1` administrative mutations     | ADR-0003, ADR-0005, ADR-0014           | AuthorizationPort, trusted grants, idempotency, optimistic concurrency | signed OIDC/API/PostgreSQL E2E 22/22                               | Tenant administration evidence      | `LOCAL_VERIFIED_REMOTE_PENDING` |
| VOL-VII-7.7/7.10               | Durable audit and justified state-change events | ADR-0006, ADR-0009, ADR-0014           | transactional audit and append-only outbox                             | atomic success/failure and tamper tests                            | Tenant administration evidence      | `LOCAL_VERIFIED_REMOTE_PENDING` |
