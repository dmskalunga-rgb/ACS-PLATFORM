...
**Status:** `READY_FOR_HUMAN_GOVERNANCE_REVIEW_NOT_IMPLEMENTATION_EVIDENCE`
...
| `X011-M0-REQ-006` tenant/auth               | Identity/trusted context/AuthorizationPort | SDR-0001; proposed permissions                                                              | Cross-tenant and privilege bypass                     | `NEG-001` to `005`                        | `REQUIRED_AT_DOD` |
...
| `X011-M0-REQ-011` events/audit              | ADR-0006; canonical audit                  | candidate event registry                                                                    | Leakage/split state                                   | `POS-006`, `NEG-015`, `FI-012`            | `REQUIRED_AT_DOD` |
