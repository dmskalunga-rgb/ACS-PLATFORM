...
| ------------- | ----------------------------------------- | ---------------------------------------------------------- | ------------------------------------- | ----------------------------------- | --------- |
| `XCF-REQ-001` | Registry / ADR-XCF-003 / TM-01            | XCF Registry / source registry / PostgreSQL                | XCF-AC-001 / XCF-NEG-007 / XCF-FI-004 | registry snapshot / QG-01 / AC-01   | M1        |
...
| `XCF-REQ-003` | History / ADR-XCF-003 / TM-02             | XCF Registry / FrameworkRelease / PostgreSQL               | XCF-AC-002 / XCF-NEG-011 / XCF-FI-009 | release lineage / QG-08 / AC-01     | M1        |
| `XCF-REQ-004` | Reproduction / ADR-XCF-011 / TM-02        | XCF DecisionEvidence / release snapshot / XCAP-005         | XCF-AC-002 / XCF-NEG-018 / XCF-FI-018 | reconstruction / QG-08 / AC-01      | M1        |
| `XCF-REQ-005` | Mapping / ADR-XCF-009 / TM-03             | XCF Mapping / mapping ID / PostgreSQL                      | XCF-AC-004 / XCF-NEG-012 / XCF-FI-010 | mapping record / QG-02 / AC-02      | M1        |
| `XCF-REQ-006` | Mapping / ADR-XCF-009 / TM-03             | XCF Mapping / versioned endpoints / PostgreSQL             | XCF-AC-004 / XCF-NEG-012 / XCF-FI-010 | mapping lineage / QG-02 / AC-02     | M1        |
| `XCF-REQ-007` | Mapping / ADR-XCF-009 / TM-03             | XCF Mapping / relationship registry / PostgreSQL           | XCF-AC-004 / XCF-NEG-012 / XCF-FI-007 | validation result / QG-02 / AC-02   | M1        |
| `XCF-REQ-008` | Mapping / ADR-XCF-009 / TM-03             | XCF Mapping / confidence / PostgreSQL                      | XCF-AC-004 / XCF-NEG-012 / XCF-FI-010 | confidence evidence / QG-02 / AC-02 | M1        |
| `XCF-REQ-009` | Mapping / ADR-XCF-009 / TM-03             | XCF Mapping / mapping class / PostgreSQL                   | XCF-AC-004 / XCF-NEG-012 / XCF-FI-010 | class audit / QG-02 / AC-02         | M1        |
| `XCF-REQ-010` | Mapping / ADR-XCF-009 / TM-03             | XCF Mapping / provenance / PostgreSQL                      | XCF-AC-005 / XCF-NEG-012 / XCF-FI-005 | rejection audit / QG-02 / AC-02     | M1        |
| `XCF-REQ-011` | Graph / ADR-XCF-004 / TM-04               | XCF Knowledge / node registry / PostgreSQL                 | XCF-AC-007 / XCF-NEG-014 / XCF-FI-017 | graph fixture / QG-02 / AC-03       | M1/M5     |
| `XCF-REQ-012` | Graph / ADR-XCF-004 / TM-04               | XCF Knowledge / edges / PostgreSQL                         | XCF-AC-007 / XCF-NEG-014 / XCF-FI-017 | traversal / QG-02 / AC-03           | M1/M5     |
| `XCF-REQ-013` | Graph / ADR-XCF-011 / TM-04               | XCF Knowledge / temporal edge / PostgreSQL                 | XCF-AC-007 / XCF-NEG-014 / XCF-FI-009 | version history / QG-08 / AC-03     | M1/M5     |
| `XCF-REQ-014` | Tenant graph / ADR-XCF-004 / TM-05        | XCF Knowledge / scope model / PostgreSQL                   | XCF-AC-008 / XCF-NEG-014 / XCF-FI-017 | RLS proof / QG-03 / AC-11           | M1/M5     |
| `XCF-REQ-015` | Vulnerability / ADR-XCF-003 / TM-06       | XCF Vuln / CVE-CWE-CVSS refs / PostgreSQL                  | XCF-AC-001 / XCF-NEG-011 / XCF-FI-006 | source lineage / QG-01 / AC-04      | M2        |
| `XCF-REQ-016` | KEV / ADR-XCF-003 / TM-06                 | XCF Vuln / KEV presence / PostgreSQL                       | XCF-AC-001 / XCF-NEG-011 / XCF-FI-004 | release proof / QG-01 / AC-04       | M2        |
| `XCF-REQ-017` | KEV provenance / ADR-XCF-003 / TM-06      | XCF Vuln / KEV source / XCAP-005 refs                      | XCF-AC-001 / XCF-NEG-011 / XCF-FI-005 | source hash / QG-01 / AC-04         | M2        |
| `XCF-REQ-018` | Priority / ADR-XCF-003 / TM-06            | XCF Vuln / priority context / PostgreSQL                   | XCF-AC-009 / XCF-NEG-016 / XCF-FI-016 | factor explanation / QG-06 / AC-04  | M2        |
| `XCF-REQ-019` | ATT&CK / ADR-XCF-003 / TM-07              | XCF Adversary / tactic / PostgreSQL                        | XCF-AC-001 / XCF-NEG-007 / XCF-FI-006 | release proof / QG-01 / AC-05       | M3        |
| `XCF-REQ-020` | ATT&CK / ADR-XCF-003 / TM-07              | XCF Adversary / technique / PostgreSQL                     | XCF-AC-001 / XCF-NEG-007 / XCF-FI-006 | object lineage / QG-01 / AC-05      | M3        |
| `XCF-REQ-021` | ATT&CK / ADR-XCF-003 / TM-07              | XCF Adversary / sub-technique / PostgreSQL                 | XCF-AC-001 / XCF-NEG-007 / XCF-FI-007 | hierarchy proof / QG-02 / AC-05     | M3        |
| `XCF-REQ-022` | Incident mapping / ADR-XCF-004 / TM-07    | CYB-001 reference / incident-technique edge / PostgreSQL   | XCF-AC-001 / XCF-NEG-007 / XCF-FI-017 | traversal / QG-02 / AC-05           | M3        |
| `XCF-REQ-023` | Assertion state / ADR-XCF-008 / TM-07     | XCAP-011 / assertion class / Fusion                        | XCF-AC-009 / XCF-NEG-016 / XCF-FI-016 | result contract / QG-06 / AC-05     | M3        |
| `XCF-REQ-024` | Defense / ADR-XCF-009 / TM-08             | XCF Defense / D3FEND edge / PostgreSQL                     | XCF-AC-004 / XCF-NEG-012 / XCF-FI-010 | mapping evidence / QG-02 / AC-06    | M4        |
| `XCF-REQ-025` | Capability map / ADR-XCF-009 / TM-08      | Capability Registry / defense-capability edge / PostgreSQL | XCF-AC-004 / XCF-NEG-012 / XCF-FI-010 | mapping audit / QG-02 / AC-06       | M4        |
| `XCF-REQ-026` | Authority boundary / ADR-XCF-005 / TM-12  | AuthorizationPort / capability ref / none                  | XCF-AC-011 / XCF-NEG-005 / XCF-FI-014 | auth decision / QG-05 / AC-09       | M4/M7     |
...
| `XCF-REQ-048` | Incident isolation / ADR-XCF-006 / TM-14  | CYB-001 / incident refs / owner DB                         | XCF-AC-014 / XCF-NEG-001 / XCF-FI-001 | RLS proof / QG-03 / AC-11           | All       |
| `XCF-REQ-049` | Evidence isolation / ADR-XCF-006 / TM-14  | XCAP-005 / evidence refs / Evidence DB                     | XCF-AC-014 / XCF-NEG-001 / XCF-FI-001 | RLS proof / QG-03 / AC-11           | All       |
| `XCF-REQ-050` | Inference leakage / ADR-XCF-002 / TM-05   | XCF Knowledge / traversal / PostgreSQL                     | XCF-AC-008 / XCF-NEG-014 / XCF-FI-017 | side-channel test / QG-03 / AC-11   | M5-M8     |
| `XCF-REQ-051` | Retrieval context / ADR-XCF-002 / TM-14   | Platform Context / retrieval / PostgreSQL                  | XCF-AC-014 / XCF-NEG-003 / XCF-FI-014 | tenant proof / QG-03 / AC-11        | M5-M8     |
| `XCF-REQ-052` | RLS preservation / ADR-XCF-002 / TM-14    | PostgreSQL / RLS/FORCE RLS / owner DB                      | XCF-AC-014 / XCF-NEG-001 / XCF-FI-001 | catalog proof / QG-03 / AC-11       | All       |
...
| `XCF-REQ-064` | Fail tenant / ADR-XCF-010 / TM-17         | Platform Context / access / owner DB                       | XCF-AC-014 / XCF-NEG-003 / XCF-FI-001 | no disclosure / QG-09 / AC-14       | All       |
