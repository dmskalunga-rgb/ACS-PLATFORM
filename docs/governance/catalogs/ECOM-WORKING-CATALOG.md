...
| Commercial Customer Registry    | VOL-VI-6.4.2; Phase 2 authorization | Commercial Product/Domain Authority; named owner `PENDING_GOVERNANCE_APPROVAL` | `IMPLEMENTED_PENDING_REMOTE_CI` | Tenant-owned customer master; no billing capability |
