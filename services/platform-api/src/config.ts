...
const configurationSchema = z.object({
  ...
  ACS_RATING_DATABASE_URL: z.url().optional(),
...
export interface PlatformConfiguration {
  ...
  readonly ratingDatabaseUrl?: string;
...
export function loadConfiguration(
  ...
  return {
    ...
    ...(parsed.ACS_RATING_DATABASE_URL === undefined
      ? {}
      : { ratingDatabaseUrl: parsed.ACS_RATING_DATABASE_URL }),
